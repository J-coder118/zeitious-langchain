...
def generate_compelling_text(var, focus=""):
    """
    Generate compelling text based on a given variable and optional focus.
...
results.append(
    (
        ...
        generate_compelling_text(
            VAR_3,
            """
Author names is Jessica.
The author is recognized as a leading voice in personal development.
She was selected as one of 50 women for SUCCESS Magazine's 2023 Women of Influence Awards.
