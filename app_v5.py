...
coach_pmt = """you are a talented {subject} coach. so please give me perfect coach for this problem: {problem}"""
...
if st.button("Generate experience:", key="experience_btn"):
    ...
    st.session_state.intro_info = "Author is Life of coach. \n\n" + coach
    st.write(experience)
    st.write(coach)
